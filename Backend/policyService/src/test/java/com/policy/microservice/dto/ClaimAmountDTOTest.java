...
public class ClaimAmountDTOTest {
	 ...
	 * 
	 * @Test void testClaimStatusDTO() { claimAmountDTO = new ClaimAmountDTO();
	 * claimAmountDTO.setClaimId("ABBB-hdh4h-yryyr");
	 ...
	 * 
	 * claimStatusDTO = new ClaimStatusDTO("ATATTA-YYYY", "Approved",
	 ...
	 * assertEquals("Your claims has been approved",claimStatusDTO.
	 * getClaimDescription());
	 * 
	 * }
	 */
