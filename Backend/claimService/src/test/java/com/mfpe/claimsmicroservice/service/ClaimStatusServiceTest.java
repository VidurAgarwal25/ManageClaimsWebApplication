...
class ClaimStatusServiceTest {
	...
	void getClaimStatusTestWithValidId() {
		...
		assertEquals(claimStatusDTO.getClaimStatus(), claimStatusService.getClaimStatus("C101","P1001","M101").getBody().getClaimStatus()); 
		assertEquals(claimStatusDTO.getClaimDescription(), claimStatusService.getClaimStatus("C101","P1001","M101").getBody().getClaimDescription()); 
	}
	*/
	/*
	@Test
	...
	void testGetClaimStatusWithInvalidValidId() {
		...
		assertThrows(InvalidClaimIdException.class, () ->
         claimStatusService.getClaimStatus("C1561","P1001","M101"));
	}
	*/
